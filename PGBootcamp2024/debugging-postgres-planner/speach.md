...
Сами RTE - это элементарные/базовые структуры. Из них создаются `RelOptInfo` -
информация об отношении. Такое соответствие можно увидеть справа.
Из таблиц, SRF и подзапросов создаются `base` relation. Такое определение.
А из JOIN - JOIN Relation.
